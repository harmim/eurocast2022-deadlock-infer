...
\title{\thetitle\thanks{%
    The work was supported by the project
    No.~20-07487S of the Czech Science Foundation.%
}}
\titlerunning{\thetitle}
...
% %
% However, concurrency does bring not only speed-ups but also a~much larger
% space for nasty errors easy to cause but difficult to find.
% %
...
% %
% Moreover, monitoring a~run of large software through such checkers may be
% quite expensive too.
...
% %
% However, the scalability of these techniques is so far not sufficient to
% handle truly large industrial code, even when combining it with methods such
% as \emph{sequentialisation}~\cite{lazy-seq-16},
% %
...
% approaches based on \emph{static analysis}, e.g., in the form of
